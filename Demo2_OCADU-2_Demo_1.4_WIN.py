...
def run_splash_screen(screen, clock):
    """Fade-in, hold, fade-out splash screen."""
...
class Button:
    def __init__(self, rect, text, base_color, glow_color, font):
        ...
        # Layer 2: press animation
        self.press_timer = 0
        self.press_duration = 5  # ~80ms at 60fps
...
# =========================
# 8) Grid class (Layer 3 integrated)
# =========================
...
class CircularGrid:
    ...
    def draw(self, surface, mouse_pos, editing_mode):
        ...
        # Layer 3: hover highlight (editing mode only)
        if editing_mode:
            mx, my = mouse_pos
...
def demo():
    ...
    while running:
        ...
        # Layer 2: decrement press timers
